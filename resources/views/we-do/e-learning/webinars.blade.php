        ...
        'introcol2' => '
            <p>
             Recently we have begun to do multi-language webinars, where presentations are made in English, French and Spanish language channels simultaneously.
                ...
                <p class="mt-2">
                The presentations are available in the <a href="' . config('app.resources_site_url') . '" target="_blank" class="font-bold text-stats4sd-red">Stats4SD Resources Library</a>. 
            </p>
        ',
        'caseStudies' => [
            [
