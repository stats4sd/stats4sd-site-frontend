...
@section('content')
    ...
    @component('components.level-3-template', [
        ...
        'content' => '
            ...
            <p class="pt-2">The statisticians at Stats4SD work closely with data systems and platforms colleagues. In some cases, clients may ask us to build a platform to handle their data, but they prefer to do 
