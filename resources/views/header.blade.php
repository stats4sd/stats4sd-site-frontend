        ...
        <div class="px-8 w-full mx-auto flex justify-between items-center py-8 fixed">
            ...
            <nav class="hidden lg:flex">
                <ul class="flex space-x-6 xl:space-x-10 font-medium text-sm xl:text-base">
                    ...
                    <li>
                        <a href="/team" class="flex items-center nav-link uppercase">
                            {{ t('Our team') }}
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/about" class="flex items-center nav-link uppercase">{{ t('About us') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ config('app.resources_site_url') }}" class="flex items-center nav-link uppercase">
                            {{ t('Resources library') }}
                        </a>
                    </li>
                    <!-- Language Dropdown
