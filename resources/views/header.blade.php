<header class="absolute top-0 left-0 w-full z-10" x-data="{ open: false }">
    <div class="px-8 max-w-screen-3xl mx-auto flex justify-between items-center py-8">
        ...
        <button 
            class="lg:hidden text-gray-800 hover:text-stats4sd-red focus:outline-none " 
    ...
    <div 
        class="lg:hidden sm:w-1/2 sm:float-right" 
        x-show="open"
            ...
            <ul class="flex flex-col space-y-2 px-8 pb-4">
                <li class="relative nav-item" x-data="{ weDoOpen: false }">
                    ...
                    <ul class=" text-sm" x-show="weDoOpen" x-transition x-cloak>
                        <li><a href="/we-do" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("Overview") }}</a></li>
                        <li><a href="/we-do/sustainable-devlopment" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("Sustainable development") }}</a></li>
                        <li><a href="/we-do/research-methods" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("Research methods and analysis") }}</a></li>
                        <li><a href="/we-do/food-systems" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("Agriculture and food systems") }}</a></li>
                        <li><a href="/we-do/data-systems" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("Data systems and platforms") }}</a></li>
                        <li><a href="/we-do/m-and-e" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("M&E and impact assessment") }}</a></li>
                        <li><a href="/we-do/e-learning" class="text-gray-800  hover:text-stats4sd-red py-2">{{ t("E-learning") }}</a></li>
                    </ul>
                </li>
