...
<section class="mx-auto  w-[90%] max-w-7xl bg-white px-12 lg:px-16 xl:px-20 pb-32">
    <div
        class=" flex flex-col lg:flex-row gap-12 {{ empty($additionalContent) ? 'items-center justify-center' : '' }}">
                            ...
                            <div @click.away="open = false"
                                ...
                                <div class="flex flex-col md:flex-row gap-6">
                                    ...
                                    <div class="flex flex-col w-full md:py-12">
                                        ...
                                        <div>
                                            <div
                                                class="flex-1 flex flex-col  border-r-12 border-stats4sd-red ml-8 pr-8">
                                            ...
                                            <div class="xl:w-5/12 flex flex-col text-sm">
                                                ...
                                                <div class="mb-3 flex flex-row items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23"
                                                        height="23" viewBox="0 0 24 24" class="flex-shrink-0">
                                                        <path
