...
<div class="max-w-screen-lg 2xl:max-w-screen-xl 3xl:max-w-screen-2xl px-12 sm:px-24 md:px-16 2xl:px-4  mx-auto">
    ...
    <section class="bg-white pt-8 pb-24 px-6 max-w-screen-lg 2xl:max-w-screen-xl 3xl:max-w-screen-2xl px-12 sm:px-24 md:px-16 2xl:px-4  mx-auto">
        <div class=" grid grid-cols-1 lg:grid-cols-12 gap-8  items-start mb-16">

            <!-- Left Side: Intro Text (4 columns on md+) -->
            <div class="md:col-span-8 lg:col-span-4 space-y-6 text-gray-800 w-full md:flex md:flex-row md:gap-12 lg:gap-0 lg:flex-col ">
                <div>
                    <p class="mb-4">
