...
@section('content')
    ...
    <div class="max-w-screen-lg 2xl:max-w-screen-xl 3xl:max-w-screen-2xl px-8 sm:px-20 md:px-12 2xl:px-20  mx-auto">
        ...
        <div class="font-semibold mb-6 pt-6 text-lg">
            {{ t("Click on a team member's photo to view their bio and contact information") }}</div>
    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 3xl:gap-12" id="team-container">
            @foreach ($teamData as $teamMember)
                <div class="relative" x-data="{ open: false }">
                    <!-- Card -->
                    <div class="cursor-pointer rounded-3xl overflow-hidden hover-effect max-w-[65vw] sm:max-w-none mx-auto sm:mx-0 sm:h-70"
                        @click="open = true">
                                    ...
                                    <div class="flex flex-col xl:flex-row gap-12 items-start mx-8 mt-8">
                                        ...
                                        <div class="xl:w-5/12 flex flex-col text-sm">
                                            ...
                                            <div class="mb-3 flex flex-row items-center">
                                                ...
                                                <div class="ml-6">
                                                    <span class="font-semibold block">{{ t('Email') }}</span>
                                            ...
                                            @if (!empty($teamMember['linkedin']))
                                                <div class="mb-3 flex flex-row items-center">
                                                    ...
                                                    <div class="ml-6">
                                                        <span class="font-semibold block">{{ t('LinkedIn') }}</span>
                                            ...
                                            @if (!empty($teamMember['github']))
                                                <div class="mb-3 flex flex-row items-center">
                                                    ...
                                                    <div class="ml-6">
                                                        <span class="font-semibold block">{{ t('GitHub') }}</span>
                                            ...
                                            @if (!empty($teamMember['google_scholar']))
                                                <div class="mb-3 flex flex-row items-center">
                                                    ...
                                                    <div class="ml-6">
                                                        <span class="font-semibold block">{{ t('Google Scholar') }}</span>
                                                        <a href="{{ $teamMember['google_scholar'] }}" target="_blank"
                                                            class="text-stats4sd-red break-words">
                                                            {{ t('View profile') }}
                                                        </a>
                                                    </div>
    ...
    <div
        ...
        <h2 class="text-4xl font-bold text-gray-900 mb-6">{{ t('Founders and Strategic Advisors') }}</h2>
    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 3xl:gap-12" id="team-container">
            @foreach ($founderData as $founder)
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div class="cursor-pointer rounded-3xl overflow-hidden hover-effect max-w-[65vw] sm:max-w-none mx-auto sm:mx-0 sm:h-70"
                        @click="open = true">
                        <img src="{{ asset($founder['avatar']) }}" alt="Photo of {{ $founder['name'] }}"
                            class="h-auto w-full ">
                    </div>
                    <div class="mt-2 px-2 max-w-[65vw] sm:max-w-none mx-auto">
                        <h4 class="text-gray-900 text-lg font-semibold">{{ $founder['name'] }}</h4>
                        <p class="text-gray-700 text-sm">{{ $founder['title'] }}</p>
                    </div>
                        ...
                        <div @click.away="open = false"
                            ...
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <div class="flex flex-col w-full md:py-12">
                                    ...
                                    <div>
                                        <div class="flex-1 flex flex-col  border-r-12 border-stats4sd-red ml-8 pr-8">
                                            <h2 class="text-3xl font-bold">{{ $founder['name'] }}</h2>
                                            <p class="text-stats4sd-red uppercase text-xl font-semibold mt-1">
                                                {{ $founder['title'] }}
                                            </p>
                                        </div>
                                        ...
                                        <div class="xl:w-5/12 flex flex-col text-sm">
                                            ...
                                            @if (!empty($founder['github']))
                                                <div class="mb-3 flex flex-row items-center">
                                                    ...
                                                    <div class="ml-6">
                                                        <span class="font-semibold block">{{ t('GitHub') }}</span>
                                                        <a href="{{ $founder['github'] }}" target="_blank"
                                                            class="text-stats4sd-red break-words">
                                                            {{ t('View profile') }}
                                                        </a>
                                                    </div>
                                            ...
                                            @if (!empty($founder['google_scholar']))
                                                <div class="mb-3 flex flex-row items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                        viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                                        <path
                                                    ...
                                                    <div class="ml-6">
                                                        <span class="font-semibold block">{{ t('Google Scholar') }}</span>
                                                        <a href="{{ $founder['google_scholar'] }}" target="_blank"
                                                            class="text-stats4sd-red break-words">
                                                            {{ t('View profile') }}
                                                        </a>
                                                    </div>
    ...
    <!-- <div class="bg-gray-100 pt-12 pb-28 mt-12">
        <div
            ...
            <a href="{{ asset('files/stats4sd_organisation_diagram_june_2025.pdf') }}"
                class="inline-block bg-black text-white px-6 py-2 !text-base font-semibold rounded-full hover-effect uppercase"
                target="_blank">
                {{ t('View PDF') }}
            </a>
